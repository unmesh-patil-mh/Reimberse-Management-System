          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            >
              <a
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLAnchorElement).style.boxShadow = '6px 6px 0 rgba(255,255,255,0.4)';
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLAnchorElement).style.boxShadow = '4px 4px 0 rgba(255,255,255,0.3)';
                }}
              >
