  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
        {/* Section header */}
        <div className="grid grid-cols-1 md:grid-cols-12 mb-16 gap-8 faq-reveal opacity-0 translate-y-4 transition-all duration-500"
          style={{ '--tw-translate-y': '1rem' } as React.CSSProperties}>
        ...
        <div className="flex flex-wrap gap-2 mb-12 faq-reveal opacity-0 translate-y-4 transition-all duration-500">
        ...
        <div className="space-y-0 border-t-2 border-black">
          {filtered.map((faq, i) => {
            ...
            return (
              <div
                key={globalIndex}
                className={`faq-reveal opacity-0 translate-y-4 transition-all duration-500 border-b-2 border-black group ${
              ...
              >
                ...
                >
                  <div className="md:pl-[calc(theme(spacing.4)+theme(spacing.24)+theme(spacing.4))] pr-14">
        ...
        {/* Bottom CTA */}
        <div className="mt-16 faq-reveal opacity-0 translate-y-4 transition-all duration-500 flex flex-col sm:flex-row items-start sm:items-center gap-6 pt-12 border-t-2 border-black">
